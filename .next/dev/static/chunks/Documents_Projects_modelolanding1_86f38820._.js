...
;
;
function WistiaVideo({ videoId, className = "rounded-2xl" }) {
...
"[project]/Documents/Projects/modelolanding1/components/scroll-video-wrapper.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"use client";
;
function ScrollVideoWrapper({ children }) {
    _s();
    const [scale, setScale] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Projects$2f$modelolanding1$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0.85);
    const [blur, setBlur] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Projects$2f$modelolanding1$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(10);
    const ref = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Projects$2f$modelolanding1$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Projects$2f$modelolanding1$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ScrollVideoWrapper.useEffect": ()=>{
            let ticking = false;
            const handleScroll = {
                "ScrollVideoWrapper.useEffect.handleScroll": ()=>{
                    if (!ticking) {
                        window.requestAnimationFrame({
                            "ScrollVideoWrapper.useEffect.handleScroll": ()=>{
                                if (ref.current) {
            ...
            return ({
                "ScrollVideoWrapper.useEffect": ()=>window.removeEventListener("scroll", handleScroll)
            })["ScrollVideoWrapper.useEffect"];
        }
    }["ScrollVideoWrapper.useEffect"], []);
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Projects$2f$modelolanding1$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        fileName: "[project]/Documents/Projects/modelolanding1/components/scroll-video-wrapper.tsx",
        lineNumber: 56,
        columnNumber: 5
    }, this);
}
_s(ScrollVideoWrapper, "fW4plqAbCm5WLqXDRrHxLvtuk5U=");
_c = ScrollVideoWrapper;
var _c;
__turbopack_context__.k.register(_c, "ScrollVideoWrapper");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=Documents_Projects_modelolanding1_86f38820._.js.map